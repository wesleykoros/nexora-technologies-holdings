...
const principles = [
  [
    "Governed by design",
    "Architecture that treats security, accountability and compliance as product foundations.",
    ShieldCheck,
  ],
  [
    "Built to integrate",
    "Modular platforms that connect people, workflows, data and external systems.",
    Workflow,
  ],
  [
    "Designed to scale",
    "A portfolio model that supports licensing, partnerships and international expansion.",
    Globe2,
  ],
] as const;
    ...
    <>
        ...
        <div className="mx-auto grid max-w-7xl items-center gap-14 pb-24 pt-12 lg:grid-cols-[1.08fr_.92fr]">
          <div className="relative z-10">
            <div className="mb-6 inline-flex items-center gap-2 rounded-full border border-[color:var(--border)] bg-[color:var(--card)] px-4 py-2 text-xs font-bold uppercase tracking-[.18em] text-[color:var(--muted)]">
              <Globe2 size={14} />
              Delaware · Global technology portfolio
            </div>
            ...
            <p className="mt-8 max-w-2xl text-lg leading-8 text-[color:var(--muted)]">
              Nexora develops, owns and commercialises intelligent platforms
              that strengthen care, compliance, governance and operational
              performance.
            </p>
          ...
          <div className="relative z-10 glass rounded-[2rem] p-5 shadow-2xl shadow-indigo-950/20">
            <div className="rounded-[1.5rem] border border-[color:var(--border)] bg-[color:var(--background)] p-7">
              <div className="mb-10 flex items-center justify-between">
                <span className="text-sm font-bold">Nexora portfolio</span>
              ...
              {[
                ["CareAxis", "Care operations"],
                ["Nexora AI", "Enterprise intelligence"],
                [
      ...
      <section className="px-5 py-24">
        <div className="mx-auto max-w-7xl">
          <Reveal>
            <p className="eyebrow">Nexora at a glance</p>

            <h2 className="section-title max-w-4xl">
              A technology holding company built for intelligent,
              regulated and essential systems.
            </h2>
          </Reveal>

          <div className="mt-12 grid gap-4 sm:grid-cols-2 lg:grid-cols-4">
            {[
              ["Delaware", "U.S. holding company"],
              ["Global", "Platform portfolio"],
              ["AI-first", "Technology direction"],
              ["Governed", "Commercialisation model"],
            ].map(([title, text]) => (
      ...
      <section className="border-y border-[color:var(--border)] px-5 py-24">
        <div className="mx-auto max-w-7xl">
          <Reveal>
            ...
            <h2 className="section-title max-w-4xl">
              Enterprise ambition with disciplined governance.
            </h2>
          </Reveal>
        ...
        <div className="mx-auto max-w-7xl">
          <Reveal>
            ...
            <h2 className="section-title">
              Designed around real operational complexity.
            </h2>
          </Reveal>
      ...
      <section className="px-5 pb-24">
        <div className="mx-auto max-w-7xl rounded-[2rem] bg-gradient-to-br from-indigo-600 via-blue-600 to-teal-500 p-9 text-white shadow-2xl shadow-indigo-950/25 sm:p-14">
          <div className="grid gap-8 lg:grid-cols-[1fr_auto] lg:items-end">
            <div>
              <p className="text-sm font-bold uppercase tracking-[.25em] text-white/70">
                Strategic partnerships
              </p>

              <h2 className="mt-4 max-w-3xl text-4xl font-black tracking-[-.04em] sm:text-6xl">
                Let&apos;s build the future together.
              </h2>

              <div className="mt-7 grid gap-3 text-sm text-white/85 sm:grid-cols-3">
                {[
                  "Platform licensing",
                  "Joint ventures",
